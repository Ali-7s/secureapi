...
public class BruteForceRule implements DetectionRule {
    ...
    public BruteForceRule(DetectionRepository detectionRepository) {
    ...
    public AttackPatternType name() {
        return AttackPatternType.BRUTE_FORCE;
    }
    ...
    public List<RuleMatch> evaluate(OffsetDateTime now) {
        ...
        return detectionRepository.findIpBruteForce(windowStart, now, threshold());
    }
