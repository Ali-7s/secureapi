...
@Component
public class RevokedKeyReuseRule implements DetectionRule {

    private final DetectionRepository detectionRepository;

    public RevokedKeyReuseRule(DetectionRepository detectionRepository) {
        this.detectionRepository = detectionRepository;
    }

    @Override
    public AttackPatternType name() {
        return AttackPatternType.REVOKED_KEY_REPLAY;
    }
