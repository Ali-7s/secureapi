...
@Component
public class PasswordSprayingRule implements DetectionRule {

    private final DetectionRepository detectionRepository;

    public PasswordSprayingRule(DetectionRepository detectionRepository) {
        this.detectionRepository = detectionRepository;
    }

    @Override
    public AttackPatternType name() {
        return AttackPatternType.PASSWORD_SPRAY;
    }
    ...
    public List<RuleMatch> evaluate(OffsetDateTime now) {
        ...
        return detectionRepository.findPasswordSpraying(windowStart, now, threshold());
    }
